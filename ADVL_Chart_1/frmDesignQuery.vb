...
#Region " Form Methods - The main actions performed by this form." '---------------------------------------------------------------------------------------------------------------------------
    ...
    Private Sub btnApply_Click(sender As Object, e As EventArgs) Handles btnApply.Click
        'Main.Data.txtQuery.Text = txtQuery.Text
        'Main.SharePrices.txtQuery.Text = txtQuery.Text
        Main.InputQuery = txtQuery.Text
    End Sub
    ...
    Private Sub btnMakeSqlStatement_Click(sender As Object, e As EventArgs) Handles btnMakeSqlStatement.Click
        ...
        Else
            If cmbConstraint1.SelectedItem.ToString = "WHERE" Then
                If cmbField1.SelectedItem Is Nothing Then
                    'No field selected!
                ElseIf cmbField1.SelectedItem.ToString = "" Then
